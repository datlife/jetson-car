...
(cl:defmethod cl:initialize-instance :after ((m <CarInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rc_car_msgs-msg:<CarInfo> is deprecated: use rc_car_msgs-msg:CarInfo instead.")))
...
(cl:defmethod throttle-val ((m <CarInfo>))
...
(cl:defmethod steer-val ((m <CarInfo>))
